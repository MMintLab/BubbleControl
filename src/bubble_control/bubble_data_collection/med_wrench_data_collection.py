...
from bubble_control.bubble_data_collection.bubble_data_collection_base import MedDataCollectionBase
...
class MedWrenchDataCollection(MedDataCollectionBase):
    ...
    def _get_legend_lines(self, data_params):
        ...
        lines = np.array([data_params[cn] for cn in column_names]).T
        return lines
