...
from bubble_control.bubble_learning.models.bubble_depth_autoencoder import BubbleAutoEncoderModel
...
if __name__ == '__main__':
    ...
    Model = [BubbleDynamicsResidualModel, BubbleAutoEncoderModel]
