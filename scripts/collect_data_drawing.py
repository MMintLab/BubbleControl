...
from bubble_control.bubble_envs.bubble_drawing_env import BubbleDrawingEnv
...
def collect_data_drawing_env_test(save_path, scene_name, num_data=10, prob_axis=0.08, impedance_mode=False, reactive=False, drawing_area_center=(0.55, 0.), drawing_area_size=(.15, .15), drawing_length_limits=(0.01, 0.15)):

    env = BubbleDrawingEnv(prob_axis=prob_axis,
                             impedance_mode=impedance_mode,
                             reactive=reactive,
                             drawing_area_center=drawing_area_center,
                             drawing_area_size=drawing_area_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--drawing_area_center', type=float, nargs=2, default=(0.53, 0.), help='x y of the drawing area center')
    ...
    parser.add_argument('--drawing_length_limits', type=float, nargs=2, default=(0.07, 0.15), help='min_length max_length of the drawing move')
