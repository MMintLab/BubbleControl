...
if __name__ == '__main__':
    ...
    path = '/home/mireiaplanaslisbona/Documents/ycb_spatula/object_models/033_spatula_berkeley_meshes/033_spatula/clouds/merged_cloud.ply'
    bpe = BubblePoseEstimator(view=view, reconstruction_frame='world', imprint_th=imprint_th, icp_th=icp_th, rate=5., verbose=view, object_name='custom', model_path=path)
